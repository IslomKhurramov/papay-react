...
export function Events() {
  const Events = [
    ...
    {
      title: "Katta chegirma endi Belissimo",
    ...
    },
    {
      ...
      desc: "Merhaba promokodi orqali 50% skidka qolga kiriting",
      author: "Chicken House",
      date: "2022/09/10",
      location: "Toshkent, Quyliq",
      img: "/restaurant/merhaba.jpg",
    },
    {
      title: "Yangicha Yondashuv Endi O'zbekistonda!!",
      desc: "O'zbekistondagi eng yirik ulgurchi bozor.\n",
      author: "Food City",
      date: "2022/08/01",
      ...
      <Container sx={{ overflow: "hidden" }}>
        <Stack className={"events_main"}>
          ...
          <Box className={"prev_next_frame"}>
            <img src="/icons/arrow_left.png" className={"swiper-button-prev"} />
